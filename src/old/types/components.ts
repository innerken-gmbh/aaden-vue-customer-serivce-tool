...
export type DataFormType = InstanceType<typeof import('@/views/components/common/DataForm').default>

export type TableHeaderType = InstanceType<
  typeof import('@/views/components/common/TableHeader.vue').default
>

export type TableFooterType = InstanceType<
  typeof import('@/views/components/common/TableFooter.vue').default
>

export type SvgIconType = InstanceType<
  typeof import('@/views/components/svg-icon/index.vue').default
>

export type SearchContentType = InstanceType<
  typeof import('@/views/components/common/SearchContent.vue').default
>
